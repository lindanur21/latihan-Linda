      ...
      <!-- <footer class="bg-neutral-200 text-center text-white dark:bg-neutral-600">
        <div class="container pt-9">
          <div class="mb-9 flex justify-center">
            <a href="https://facebook.com/" class="mr-9 text-neutral-800 dark:text-neutral-200">
              <svg
            ...
            <a href="https://twitter.com/" class="mr-9 text-neutral-800 dark:text-neutral-200">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-4 w-4"
                fill="currentColor"
            ...
            <a href="https://goggle.com/" class="mr-9 text-neutral-800 dark:text-neutral-200">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-5 w-5"
                fill="currentColor"
            ...
            <a href="https://instagram.com/" class="mr-9 text-neutral-800 dark:text-neutral-200">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-4 w-4"
                fill="currentColor"
...
<template>
  <footer class="relative mt-20 bg-gray-900 px-4 pt-20">
    <div class="absolute -top-10 left-1/2 h-16 w-16 -translate-x-1/2 rounded-xl border-4 border-red-500 bg-white p-2"><img class="h-full object-contain" src="../assets/logo-carousell.png" alt="" /></div>
